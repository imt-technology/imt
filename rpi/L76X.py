    ...
    def L76X_Gat_GNRMC(self):
        ...
        for i in range(0, BUFFSIZE - 71):
            if (ord(data[add]) == 36 and ord(data[add+1]) == 71 and
                (ord(data[add+2]) == 78 or ord(data[add+2]) == 80) and
                ord(data[add+3]) == 82 and ord(data[add+4]) == 77 and
                    ord(data[add+5]) == 67):
                x = 0
                z = 0
                while x < 12:
                    ...
                    if ord(data[add+z]) == 44:
                        ...
                        if x == 1:
                            ...
                            self.Status = 1 if ord(data[add+z+1]) == 65 else 0
                        elif x == 3:
                            latitude = 0
                            for k in range(0, BUFFSIZE-1):
                                if add+z+k >= BUFFSIZE-1:
